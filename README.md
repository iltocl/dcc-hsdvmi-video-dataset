...
- [A Dataset for Hate Speech Detection in Videos](#a-dataset-for-hate-speech-detection-in-videos)
   ...
   - [Getting Started](#getting-started)
     ...
     - [1. Collecting the videos](#collecting-the-videos)
     - [2. Video segmentation](#video-segmentation)
     - [3. Video segments into batches](#video-segments-into-batches)
     - [4. Annotating the videos](#annotating-the-videos)
     - [5. Formalizing the dataset](#formalizing-the-dataset)
   - [Citation](#citation)
